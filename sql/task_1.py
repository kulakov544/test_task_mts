...
В первом запросе к таблице присоединяется она же таким образом, чтобы присоединенная запись
соответствовала записи руководителя.

Во втором запросе делается подзапрос, который находит роководителя зарплата которого
